...
export class ProductListComponent {
  ...
  totalProductsInStock = this.products.filter(a=>a.is_in_inventory==true).length;
  totalProductsOutofStock = this.products.filter(a=>a.is_in_inventory==false).length;
